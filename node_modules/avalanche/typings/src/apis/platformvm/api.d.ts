 ...
 */
declare class PlatformVMAPI extends JRPCAPI {
    /**
     ...
     */
    exportAVAX: (amount: BN, to: string, payerNonce: number) => Promise<string>;
    /**
     * Send AVAX from an account on the P-Chain to an address on the X-Chain. This transaction
     ...
     * by calling issueTx.
     */
    importAVAX: (username: string, password: string, to: string, payerNonce: number) => Promise<string>;
    /**
